...
type Person struct {
	...
	Groups    pq.StringArray `json:"groups" gorm:"type:varchar(64)[]"`
}
...
type Group struct {
	...
	Admins      pq.StringArray `json:"admins" gorm:"type:varchar(64)[]"`
	Members     pq.StringArray `json:"members" gorm:"type:varchar(64)[]"`
}
